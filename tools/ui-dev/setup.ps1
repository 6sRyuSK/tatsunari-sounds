...
Write-Host "    .\tools\ui-dev\dev.ps1 -App tn-vocal-tuner  # Pitch Fix on http://127.0.0.1:8082"
Write-Host "    .\tools\ui-dev\dev.ps1 -App tn-equalizer # Dynamic EQ on http://127.0.0.1:8083"
