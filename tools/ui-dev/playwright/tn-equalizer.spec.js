...
(async () => {
  ...
  const shot = await page.locator("#canvas").screenshot({ path: path.join(OUT, "tn-equalizer.png") });
  ...
  const result = { url: URL, passed, webgl, asserts, errors, screenshot: path.join(OUT, "tn-equalizer.png") };
