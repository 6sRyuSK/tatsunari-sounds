#pragma once
//
// DeqStateMigration.h — the tn-equalizer state-load policy for the clap-first build.
...
// tn-equalizer does NOT import the legacy JUCE session state. StateCodec is framing-/tag-
