//
// plugins/tn-resonance-suppressor/ui/tests/rs_ui_pure_test.cpp — headless unit tests
...
//
// Manual run:
//   c++ -std=c++17 -Iplugins/tn-resonance-suppressor/ui -Iui/visage/include \
//       -Iparams/include -Icore/include \
//       plugins/tn-resonance-suppressor/ui/tests/rs_ui_pure_test.cpp -o rs_ui_pure && ./rs_ui_pure
//
...
int main()
{
    std::printf ("tn-resonance-suppressor pure-UI helpers — headless checks\n");
    checkParseFreqEntry();
    checkFooterColumns();
