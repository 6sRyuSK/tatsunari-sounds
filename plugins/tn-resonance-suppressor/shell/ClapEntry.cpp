//
// ClapEntry.cpp — the tn-resonance-suppressor CLAP plugin impl (IMPL_TARGET static
...
//
// clap_plugin_descriptor id: jp.tatsunari-sounds.tn-resonance-suppressor (reverse-DNS).
//
#include <clap/clap.h>
...
namespace
{
    ...
    const clap_plugin_descriptor_t s_desc = {
        CLAP_VERSION_INIT,
        "jp.tatsunari-sounds.tn-resonance-suppressor",   // id (reverse-DNS)
        "TN Resonance Suppressor",                    // name
...
// .cpp) and forwards here. RsClapPolicy is visible from the anonymous namespace above
// within this TU.
FACTORY_CLAP_ENTRY (RsClapPolicy)
