//
// clap_shell_test.cpp — headless verification of the tn-resonance-suppressor CLAP
...
int main()
{
    ...
    // The snap moved into factory_shell::ResizableEditorGeometry so RS and tn-equalizer could
    ...
    // tn-equalizer's box: design 740x520, limits 620x440 .. 1280x900.
    //
