...
//
// RsWidgets — the light-weight Component set for the TN Resonance Suppressor
...
namespace rs
{
    ...
    // --------------------------------------------------------------- RsBrand
    // Header brand: 30x30 gradient logo square + "TN Resonance Suppressor"
    ...
    public:
        void paint (juce::Graphics& g) override
        {
            ...
            const juce::String a = "TN ", b = "Resonance Suppressor";
