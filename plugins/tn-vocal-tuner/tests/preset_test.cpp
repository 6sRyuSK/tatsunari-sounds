//
// plugins/tn-vocal-tuner/tests/preset_test.cpp — headless wiring test for the TN Vocal
// Tuner parameter table and factory-preset bank. Links only factory_params
