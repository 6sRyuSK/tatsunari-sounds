#pragma once
//
// plugins/tn-vocal-tuner/ui/PfEditor.h — pf_ui::PfEditor, the JUCE-free Visage editor
// of TN Vocal Tuner. DELIBERATELY SIMPLE (the product is in its DSP phase): it
