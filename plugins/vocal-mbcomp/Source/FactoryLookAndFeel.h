...
//
// Dark LookAndFeel for the vocal multiband compressor. Mint-green accent for its
// own identity. Header-only.
//
...
public:
    ...
    static juce::Colour accent()     { return juce::Colour (0xff63d19a); } // mint
    static juce::Colour accentDim()  { return juce::Colour (0xff2f6f55); }
