...
//
// Dark LookAndFeel for the bus compressor. Cool teal accent (dynamics control)
// to give the plugin its own identity. Header-only.
//
...
public:
    ...
    static juce::Colour accent()     { return juce::Colour (0xff35c0b0); } // teal
    static juce::Colour accentDim()  { return juce::Colour (0xff1f6f66); }
