...
//
// Dark LookAndFeel for the granular delay. Coral/pink accent for its own
...
public:
    ...
    static juce::Colour accent()     { return juce::Colour (0xffff6b81); } // coral
    static juce::Colour accentDim()  { return juce::Colour (0xff8a3a47); }
