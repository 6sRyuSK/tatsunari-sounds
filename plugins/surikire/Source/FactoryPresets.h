...
namespace surikire_presets
{
    ...
    // Intentionally empty (Init only): preset values are taste and are added
    // only after a human audition sign-off (CLAUDE.md "Ask a human" #1).
