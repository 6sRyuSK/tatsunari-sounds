...
//
// Dark LookAndFeel for the shimmer reverb. Indigo/periwinkle accent for its own
// identity. Header-only.
//
class FactoryLookAndFeel : public juce::LookAndFeel_V4
{
public:
    static juce::Colour background() { return juce::Colour (0xff15171f); }
    static juce::Colour panel()      { return juce::Colour (0xff1e2230); }
    static juce::Colour track()      { return juce::Colour (0xff2c3142); }
    static juce::Colour accent()     { return juce::Colour (0xff7d8cff); } // indigo
    static juce::Colour accentDim()  { return juce::Colour (0xff3f4794); }
